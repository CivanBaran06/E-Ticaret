// 39 Ürün (resimsiz)
const products = [
  "Telefon","Laptop","Kulaklık","Saat","Klavye","Mouse","Şarj Aleti","Powerbank","USB Bellek",
  "SSD Disk","Harddisk","Monitör","Yazıcı","Hoparlör","Mikrofon","Webcam","Router","Tablet",
  "TV","Kamera","Drone","Akıllı Lamba","Bluetooth Hoparlör","Tripod","Oyun Konsolu","Joystick",
  "VR Gözlük","Projeksiyon","Modem","RAM Bellek","Ekran Kartı","Anakart","İşlemci","Kasa",
  "Soğutucu","Kablo","Çanta","Kulak İçi Kulaklık","Kablosuz Klavye","Kablosuz Mouse","Adaptör","Mousepad","Ses Kartı","DVD Yazıcı","Fan"
].map((name, i) => ({id:i+1, name, price: Math.floor(Math.random()*5000+200)}));
